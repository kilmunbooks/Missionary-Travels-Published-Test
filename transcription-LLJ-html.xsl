	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<link rel="stylesheet" type="text/css" href="http://livingstoneonline.github.io/LEAP-XSLT/style-LLJ-html.css"/><!-- http://livingstoneonline.github.io/Missionary-Travels-Published-Text/ -->
				<title>
